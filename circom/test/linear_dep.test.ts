...
describe('Proof test', () => {
    ...
    it("Should create malleable proof", async () => {
        ...
        const private_inputs_hash_buff = poseidon([b, c, d, e].map((x) => x.toString()));
    ...
    //it("Should create malleable proof from hardcoded proof", async () => {
        ...
        //// This proof comes from the groth-puzzle repository. It's here to test
        //// whether buildMalleabeC works on any proof, not just the one
        //// generated for linear_dep.circom
